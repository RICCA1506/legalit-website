...
export const practiceAreasEnhanced: PracticeArea[] = [
  ...
  {
    id: "diritto-penale",
    titleIT: "Diritto Penale e Penale d'Impresa",
    titleEN: "Criminal Law and Corporate Criminal Law",
    ...
    fullDescriptionIT: "Lo studio vanta una consolidata esperienza nel diritto penale, offrendo assistenza e difesa in ogni tipologia di procedimento penale. I nostri avvocati penalisti assistono imputati, indagati e parti offese in tutte le fasi del procedimento, dalle indagini preliminari fino ai gradi successivi di giudizio. Particolare attenzione viene dedicata al diritto penale d'impresa, con assistenza specializzata per reati societari, tributari, fallimentari e contro la pubblica amministrazione.",
    fullDescriptionEN: "The firm has consolidated experience in criminal law, offering assistance and defense in all types of criminal proceedings. Our criminal lawyers assist defendants, suspects, and victims at all stages of the proceedings, from preliminary investigations to subsequent levels of judgment. Special attention is dedicated to corporate criminal law, with specialized assistance for corporate, tax, bankruptcy crimes and crimes against public administration.",
  ...
  },
  {
    ...
    titleIT: "Recupero Crediti, NPL e Procedure Esecutive",
    titleEN: "Debt Recovery, NPL and Enforcement Proceedings",
    shortDescriptionIT: "Recupero crediti giudiziale e stragiudiziale, gestione NPL e procedure esecutive.",
  ...
  },
  {
    ...
    titleEN: "Administrative and Accounting Liability",
  ...
  },
  {
    ...
    titleIT: "Affari regolatori & Public Affairs",
    titleEN: "Regulatory Affairs & Public Affairs",
  ...
  },
  {
    ...
    titleIT: "Tutela dei Patrimoni, Famiglia, Minori e Successioni",
    titleEN: "Asset Protection, Family, Minors and Inheritance",
