...
export const practiceAreasEnhanced: PracticeArea[] = [
  {
    ...
    fullDescriptionIT: "Legalit, attraverso il proprio dipartimento specializzato, presta assistenza giudiziale e consulenza stragiudiziale a imprese, gruppi societari, società partecipate, enti pubblici e pubbliche amministrazioni in materia di diritto del lavoro, sindacale e previdenziale. Lo Studio garantisce una consulenza continuativa tesa alla corretta gestione del rapporto di lavoro, dal drafting contrattuale agli inquadramenti, dalla definizione delle politiche retributive e dei sistemi incentivanti all'esercizio del potere disciplinare, in osservanza delle relative garanzie procedurali, assicurando altresì la necessaria assistenza tecnica nei procedimenti ispettivi previdenziali. Lo Studio supporta le imprese nelle operazioni di riorganizzazione e ristrutturazione aziendale, curando l'attivazione degli ammortizzatori sociali e lo svolgimento delle procedure di gestione degli esuberi, i processi di outsourcing, appalti e distacchi, al fine di prevenire l'insorgenza del contenzioso. L'affiancamento al management si declina tanto nella negoziazione di contratti, patti di non concorrenza e accordi di retention, quanto nella gestione stragiudiziale e contenziosa delle risoluzioni del rapporto. Particolare attenzione è dedicata alle relazioni industriali, con un'assistenza mirata nella negoziazione di accordi collettivi di secondo livello. I professionisti dello Studio affiancano inoltre le imprese nelle operazioni straordinarie e di M&A: l'intervento copre l'intero processo di trasferimento d'azienda o di ramo, partendo dall'istruttoria preventiva sino alla pianificazione strategica per la corretta gestione delle procedure di consultazione sindacale e all'armonizzazione dei trattamenti applicati al personale interessato. L'approccio sistematico dello Studio è costantemente orientato alla prevenzione del rischio, alla tutela dell'assetto organizzativo aziendale e alla gestione consapevole degli impatti economici e reputazionali connessi alle decisioni in materia di lavoro. Lo Studio fornisce altresì consulenza e difesa in giudizio in favore dei prestatori di lavoro, con una specifica e consolidata expertise dedicata alle figure apicali e dirigenziali.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Lo Studio assiste persone fisiche, società e loro amministratori, in ogni fase del procedimento penale, con riguardo ad ogni tipologia di reato, con particolare esperienza nella difesa dei c.d. \"colletti bianchi\". I professionisti dello Studio hanno maturato, infatti, un'esperienza distintiva nella difesa in giudizio in materia di reati societari, fallimentari, tributari, ambientali, finanziari, reati contro il patrimonio, reati in materia di salute e sicurezza sul lavoro, colpa medica, diffamazione, con particolare riguardo alla diffamazione a mezzo stampa, nonché nei procedimenti relativi a corruzione, concussione, turbative d'asta, peculato e altri illeciti connessi all'attività d'impresa e ai rapporti con soggetti pubblici. Lo Studio predilige un approccio difensivo proattivo, fin dalla fase delle indagini preliminari, svolgendo ove possibile indagini difensive, anche attraverso il coordinamento di consulenti tecnici di parte di rinomata fama, al fine di ricostruire i fatti, acquisire elementi probatori e predisporre una strategia difensiva solida e tempestiva, con l'obiettivo di minimizzare gli impatti del procedimento penale ed il rischio di applicazione di misure cautelari personali o patrimoniali già dalla fase delle indagini preliminari. Lo Studio assiste inoltre le società e gli altri enti coinvolti nei procedimenti penali quali parti civili, responsabili civili o incolpati ai sensi del d.lgs. 231/01, coniugando la difesa nel procedimento con il supporto alla governance nell'adozione delle scelte finalizzate al self cleaning, alla migliore tutela dell'immagine e della continuità aziendale. Accanto all'attività difensiva, Legalit affianca le imprese nella prevenzione del rischio penale, fornendo pareri pro veritate e assistenza legale qualificata a supporto delle scelte strategiche degli amministratori e degli organi di governance, al fine di valutare ex ante i profili di esposizione e mitigare il rischio di responsabilità personale e societaria. Particolare attenzione è dedicata alla gestione degli impatti reputazionali connessi al procedimento penale, per la gestione dei quali lo studio ha strutturato collaborazioni con consulenti di riconosciuta esperienza, specialisti nella comunicazione di crisi e litigation PR, così potendo supportare il management nella definizione di strategie di comunicazione coerenti con la linea difensiva, tutelando l'immagine aziendale e la continuità operativa. L'approccio integra competenze penalistiche, societarie e di compliance, assicurando una gestione coordinata dei rischi legali e reputazionali connessi all'attività d'impresa.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste le imprese nella progettazione, implementazione e aggiornamento di sistemi di compliance finalizzati alla prevenzione dei rischi legali, alla tutela della società e degli esponenti aziendali e alla definizione di assetti organizzativi adeguati a supportare lo sviluppo del business. Lo Studio offre consulenza specialistica, connotata da consolidata esperienza, in materia di responsabilità amministrativa degli enti ex D.Lgs. 231/01, curando la redazione e l'aggiornamento dei Modelli di Organizzazione, Gestione e Controllo, la mappatura dei rischi, la predisposizione dei protocolli interni e l'integrazione con i sistemi di controllo esistenti. I partner dello Studio vantano consolidata esperienza di Presidenti e componenti di Organismi di Vigilanza, anche in primarie società multinazionali e società partecipate pubbliche, e pertanto sono a disposizione per svolgere le funzioni di OdV, supportando le imprese nelle attività di monitoraggio, verifica dell'idoneità e dell'efficace attuazione dei modelli organizzativi e gestione delle segnalazioni. L'assistenza comprende la definizione e l'implementazione di procedure Whistleblowing e la gestione dei relativi canali di segnalazione, comprese le verifiche in ordine alle notizie di condotte illecite pervenute attraverso tali canali, assicurando conformità normativa, riservatezza e adeguata tutela dei segnalanti. Lo Studio affianca inoltre le imprese nella strutturazione di progetti di compliance integrata, coordinando i presidi 231 con gli altri sistemi di controllo (anticorruzione, privacy, sicurezza sul lavoro, antiriciclaggio, ESG), anche svolgendo per conto delle società clienti funzioni di Compliance Officer in outsourcing. Particolare rilievo assume l'attività di Internal Investigations, svolta a supporto del management, dell'Internal Audit e degli Organismi di Vigilanza in presenza di eventi significativi quali procedimenti penali, segnalazioni di reato, violazioni del modello 231, frodi aziendali o condotte disciplinarmente rilevanti. Le indagini interne sono condotte con metodologia strutturata e indipendente e si concludono con la redazione di report utilizzabili in sede giudiziaria, sia penale sia disciplinare, nonché nell'ambito dei procedimenti interni di accertamento delle responsabilità. L'obiettivo è fornire all'impresa strumenti concreti per prevenire il rischio reato, gestire tempestivamente le criticità e rafforzare la cultura della legalità e della responsabilità organizzativa.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste società, imprenditori, investitori e gruppi industriali nelle operazioni societarie ordinarie e straordinarie, nonché nella gestione e nel rafforzamento della governance societaria. L'attività comprende la costituzione di società, la predisposizione e revisione di statuti e patti parasociali, la regolamentazione dei rapporti tra soci, la definizione degli assetti di governance e l'assistenza continuativa agli organi sociali. Lo Studio fornisce inoltre supporto in operazioni di acquisizione e cessione di partecipazioni, fusioni e scissioni, riorganizzazioni societarie, joint venture, operazioni straordinarie funzionali a processi di crescita, consolidamento o ristrutturazione. Legalit assiste le parti in tutte le fasi dell'operazione: dalla strutturazione preliminare alla due diligence legale, dalla negoziazione dei contratti alla gestione del closing e post-closing, con un approccio integrato rispetto ai profili fiscali, finanziari, regolatori e di compliance. Particolare rilievo assume il supporto agli organi sociali nel loro funzionamento e nelle scelte strategiche. Lo Studio, integrando competenze di diritto societario e diritto penale societario, affianca gli organi sociali nella valutazione preventiva dei rischi legali connessi alle decisioni gestionali, nella predisposizione di pareri e nella definizione di assetti organizzativi adeguati, in un'ottica di costante prevenzione del rischio e tutela della responsabilità degli amministratori e sindaci. Lo Studio annovera tra i propri partner professionisti che hanno maturato consolidata esperienza anche come amministratori indipendenti e amministratori di società a partecipazione pubblica, potendo così offrire alla governance della Società Cliente un supporto qualificato e operativo, anche mediante l'assunzione di incarichi di Consigliere d'Amministrazione indipendente. Lo Studio assiste inoltre in materia di contenzioso societario, con particolare riferimento a: impugnazione di delibere assembleari e consiliari; azioni di responsabilità nei confronti di amministratori e sindaci; conflitti tra soci e abuso di maggioranza; revoca di organi sociali; controversie in materia di patti parasociali e assetti di governance.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste istituti di credito, intermediari finanziari, fondi e imprese in operazioni di finanziamento, ristrutturazione, gestione del rischio bancario e finanziario e gestione del contenzioso. L'attività comprende la strutturazione e negoziazione di operazioni di finanziamento corporate e immobiliare, finanziamenti garantiti, operazioni di leveraged finance, accordi di ristrutturazione del debito, nonché la predisposizione e revisione della contrattualistica bancaria e finanziaria. Legalit offre inoltre assistenza nella gestione del contenzioso bancario e finanziario, nelle azioni di recupero e nella tutela del credito, nonché supporto ad istituti di credito ed intermediari finanziari su profili regolatori e di governance. L'approccio è orientato alla prevenzione del rischio, alla sostenibilità delle operazioni e alla tutela della stabilità patrimoniale delle parti coinvolte.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste imprese, imprenditori e organi societari nella gestione delle situazioni di crisi e nella definizione di percorsi di risanamento e ristrutturazione, con un approccio orientato alla continuità aziendale e alla tutela del valore dell'impresa. Lo Studio affianca il management già nella fase di prima emersione degli indici di squilibrio economico-finanziario e nella predisposizione di adeguati assetti organizzativi ai sensi dell'art. 2086 c.c. L'integrazione con i professionisti dello Studio specializzati in diritto penale societario e fallimentare e con il dipartimento di diritto del lavoro consente di supportare gli amministratori, fin dalle fasi preliminari, nelle scelte strategiche connesse alla prevenzione e alla gestione della crisi, riducendo l'esposizione a rischi e profili di responsabilità. L'attività comprende l'assistenza nelle procedure di composizione negoziata, negli accordi di ristrutturazione dei debiti, nei piani attestati di risanamento, nei piani di ristrutturazione soggetti ad omologazione, nei concordati preventivi e nelle liquidazioni giudiziali, nonché nella gestione dei rapporti con creditori, istituti di credito e stakeholders. Legalit, anche attraverso partnership con commercialisti specializzati in crisi e risanamento, supporta le imprese nella riorganizzazione societaria e finanziaria, nella rimodulazione dell'esposizione debitoria e nella negoziazione di accordi transattivi complessi, coordinando i profili societari, bancari, fiscali e di compliance dell'operazione. Lo Studio presta assistenza agli amministratori e agli organi di controllo nella valutazione delle responsabilità nella causazione e gestione della crisi, con particolare attenzione ai profili di responsabilità civile e penale. Accanto all'attività in favore delle imprese, Legalit fornisce supporto agli organi delle procedure concorsuali – curatori, commissari e liquidatori – nell'analisi delle cause della crisi, nell'individuazione di eventuali responsabilità degli amministratori e degli organi di controllo e nella promozione delle conseguenti azioni di responsabilità.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste istituti di credito, intermediari finanziari, servicer e imprese nella gestione, valorizzazione e recupero del credito, sia in fase stragiudiziale sia in sede contenziosa. Lo Studio fornisce supporto nella strutturazione e negoziazione di operazioni su portafogli NPL e UTP, nella gestione delle posizioni deteriorate e nelle attività di due diligence legale su crediti e garanzie. L'assistenza comprende l'attivazione e la gestione di procedure esecutive mobiliari e immobiliari, pignoramenti, azioni cautelari, insinuazioni al passivo e azioni revocatorie, nonché il coordinamento con le procedure concorsuali. L'obiettivo è massimizzare il valore del credito, ridurre i tempi di recupero e gestire in modo efficiente il rischio legale e patrimoniale.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste imprese, enti pubblici, enti locali e stazioni appaltanti nella gestione di procedimenti amministrativi complessi e nell'ambito della contrattualistica pubblica. Lo Studio fornisce consulenza e assistenza in materia di gare e appalti pubblici, dalla fase di predisposizione della documentazione di gara alla partecipazione, fino alla gestione delle controversie innanzi al giudice amministrativo. Per le imprese, l'attività comprende: assistenza nella partecipazione a procedure di affidamento; supporto nella gestione delle esclusioni, soccorsi istruttori e verifiche dei requisiti; impugnazione di atti di gara; consulenza nella fase esecutiva del contratto pubblico. Per enti locali e stazioni appaltanti, Legalit offre supporto nella redazione di bandi, disciplinari e contratti, nella gestione delle procedure di affidamento, nella prevenzione del contenzioso e nella tutela in giudizio. L'approccio integra competenze in materia di anticorruzione, trasparenza, responsabilità amministrativa e governance pubblica, assicurando un presidio completo del rischio amministrativo e contenzioso.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste amministratori pubblici, dirigenti, funzionari, dipendenti di enti pubblici e società partecipate nei procedimenti innanzi alla Corte dei conti, nonché enti e amministrazioni coinvolti in giudizi di responsabilità erariale. Lo Studio offre consulenza preventiva e difesa in materia di: danno erariale; responsabilità per atti di gestione; responsabilità connesse alla gestione di fondi pubblici; responsabilità in ambito societario per società a partecipazione pubblica. L'attività si estende alla valutazione preventiva dei rischi connessi a scelte gestionali e procedimenti amministrativi, con particolare attenzione ai profili di legittimità, correttezza contabile e sostenibilità finanziaria. L'integrazione con le practice di diritto penale d'impresa, compliance e diritto amministrativo consente una gestione coordinata delle posizioni che presentano potenziali riflessi anche sotto il profilo penale o disciplinare. L'obiettivo è garantire tutela personale e istituzionale, riducendo l'esposizione al rischio e preservando la continuità dell'azione amministrativa.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste imprese, enti pubblici e operatori dei settori regolati nella gestione degli adempimenti ambientali, nella prevenzione del rischio sanzionatorio e nella gestione del contenzioso. Con riferimento al diritto ambientale l'attività comprende l'assistenza nei profili giuridici connessi a: autorizzazioni ambientali (AIA, AUA e titoli abilitativi); gestione dei rifiuti; bonifiche e responsabilità ambientale; valutazioni di impatto ambientale. Lo Studio assiste inoltre imprese ed enti pubblici in procedimenti sanzionatori e contenzioso amministrativo e penale in materia ambientale. Nel settore energia, lo Studio fornisce assistenza in materia di autorizzazioni per impianti, rapporti con autorità competenti, contrattualistica energetica e gestione dei profili regolatori. Per le amministrazioni e le stazioni appaltanti, Legalit offre supporto nella gestione dei procedimenti ambientali e nella predisposizione di atti e provvedimenti complessi, garantendo coerenza normativa e prevenzione del contenzioso. L'approccio, che integra le competenze in ambito amministrativo, penale e compliance, è orientato alla prevenzione del rischio, alla sostenibilità delle scelte operative e alla tutela della reputazione dell'ente o dell'impresa.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste imprese e associazioni di categoria nella gestione dei profili giuridici connessi alla regolazione dei mercati e ai rapporti con istituzioni, enti regolatori e autorità di vigilanza. Lo Studio fornisce consulenza nell'interpretazione e applicazione di normative settoriali complesse, supportando i clienti nell'adeguamento agli obblighi regolatori e nella gestione dei procedimenti amministrativi. L'attività si estende all'assistenza nei rapporti con autorità indipendenti e enti di vigilanza, anche in sede di procedimenti autorizzativi, ispettivi e sanzionatori, mediante la predisposizione di interpelli e memorie difensive, nonché – ove necessario – attraverso l'impugnazione dei provvedimenti amministrativi innanzi alle competenti autorità giudiziarie. Legalit assiste inoltre singole imprese e associazioni di categoria nell'analisi dell'impatto normativo di nuove disposizioni legislative e regolamentari sull'attività economica, elaborando soluzioni tecnico-giuridiche volte a garantire sostenibilità e coerenza sistematica degli interventi normativi. In tale ambito, lo Studio: redige pareri e analisi normative specialistiche; svolge attività di monitoraggio legislativo; predispone osservazioni, contributi tecnici, position paper e note illustrative nell'ambito di consultazioni pubbliche; elabora proposte di regolamentazione, modifiche legislative ed emendamenti tecnici; supporta le associazioni di categoria nelle audizioni presso commissioni parlamentari e nelle interlocuzioni con i decisori pubblici nazionali ed europei.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste imprese, imprenditori e professionisti nella gestione delle problematiche fiscali, offrendo consulenza qualificata e difesa nel contenzioso tributario. L'attività comprende la consulenza in materia di imposte dirette e indirette, fiscalità d'impresa, accertamenti fiscali e verifiche dell'Amministrazione finanziaria, nonché il supporto nella fase precontenziosa, inclusi contraddittori, istanze di autotutela, accertamenti con adesione e definizioni agevolate. Lo Studio presta assistenza nel contenzioso innanzi alle Corti di Giustizia Tributaria di primo e secondo grado e in sede di legittimità, con un approccio orientato alla tutela degli interessi economici dell'impresa e alla gestione strategica del rischio fiscale. Particolare attenzione è dedicata ai profili di interazione tra procedimento tributario e procedimento penale tributario. Legalit vanta consolidata esperienza nella difesa in materia di reati tributari e assicura una gestione coordinata delle due dimensioni – amministrativa e penale – al fine di garantire coerenza difensiva, tutela degli amministratori e contenimento degli effetti patrimoniali e reputazionali. L'integrazione tra competenze tributarie e penalistiche consente di affrontare in modo unitario le situazioni di maggiore complessità, anche in presenza di sequestri, misure cautelari reali e contestazioni di responsabilità nei confronti degli organi societari.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste strutture sanitarie pubbliche e private, enti del Servizio Sanitario, società e professionisti operanti nei settori sanitario, socio-assistenziale, farmaceutico e biomedicale, garantendo competenze specialistiche nella gestione dei peculiari profili giuridici che caratterizzano tali ambiti. Lo Studio fornisce consulenza in materia di organizzazione e governance delle strutture sanitarie, accreditamento e autorizzazioni, rapporti con il Servizio Sanitario Nazionale e Regionale, contrattualistica sanitaria, gestione dei rapporti con fornitori e pazienti, nonché dei rapporti di lavoro con medici e personale sanitario. Particolare rilievo assume l'assistenza nei procedimenti per responsabilità medica e degli altri professionisti sanitari, sia in sede civile sia penale. L'approccio integra valutazione tecnico-scientifica e strategia processuale, anche attraverso il coordinamento di consulenti medico-legali di comprovata esperienza. Legalit presta inoltre assistenza nei procedimenti innanzi alla Corte dei conti e nelle ipotesi di responsabilità amministrativo-contabile connesse alla gestione delle strutture sanitarie pubbliche. Nell'ambito life sciences, lo Studio supporta imprese operanti nei settori farmaceutico, biomedicale e delle tecnologie sanitarie nella gestione dei profili regolatori, nella compliance di settore e nella valutazione delle responsabilità connesse alla produzione, commercializzazione e sperimentazione di farmaci, dispositivi medici e tecnologie innovative. Lo Studio può contare sull'esperienza maturata da alcuni partner in ambito istituzionale sanitario – anche con incarichi presso il Ministero della Salute e AGENAS – nonché in ruoli di governance e controllo all'interno di primari enti sanitari, società farmaceutiche e realtà del settore biomedicale. Tali esperienze, unite all'integrazione con le practice di diritto penale d'impresa, compliance, privacy e cybersecurity, consentono allo Studio di offrire un presidio avanzato nella gestione dei rischi legali in ambito sanitario, nell'implementazione di modelli organizzativi e sistemi di controllo, nella tutela dei dati sanitari, nella sicurezza informatica delle strutture e nella tutela della salute e sicurezza del personale sanitario, anche attraverso progetti di compliance integrata.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste imprese ed enti pubblici nella gestione dei profili giuridici connessi al trattamento dei dati personali, all'adozione di sistemi di intelligenza artificiale e alla sicurezza delle infrastrutture digitali. In materia di protezione dei dati personali, lo Studio fornisce consulenza nell'adeguamento al Regolamento (UE) 2016/679 (GDPR) e alla normativa nazionale, curando: mappatura dei trattamenti e predisposizione dei registri ex art. 30 GDPR; redazione e aggiornamento di informative, policy privacy e procedure interne; nomine e contrattualistica con responsabili del trattamento; gestione dei rapporti tra titolare, contitolari e responsabili; svolgimento di valutazioni d'impatto sulla protezione dei dati (DPIA); supporto al DPO e agli organi di controllo interno. Lo Studio presta assistenza nella gestione di data breach, nella predisposizione delle notifiche all'Autorità Garante e agli interessati, nonché nella gestione del contenzioso e dei procedimenti sanzionatori conseguenti alle attività ispettive dell'Autorità Garante. I professionisti dello studio sono in grado di svolgere la funzione di Responsabile per la Protezione dei Dati (DPO) per società pubbliche e private, enti pubblici e PA. Con riferimento ai sistemi di intelligenza artificiale, Legalit supporta le imprese nella qualificazione giuridica delle soluzioni adottate, nella valutazione dei profili di rischio e nella verifica di conformità alla normativa europea in materia di AI, con particolare riguardo a: classificazione dei sistemi in base al livello di rischio; obblighi di trasparenza e informazione; valutazione dei rischi per i diritti fondamentali; responsabilità derivanti dall'utilizzo di sistemi automatizzati; integrazione dei presidi di controllo nei modelli organizzativi aziendali. In ambito cybersecurity, lo Studio assiste nella definizione di assetti organizzativi adeguati alla prevenzione degli incidenti informatici, nella predisposizione di policy di sicurezza, nella contrattualistica IT e cloud, nonché nella gestione delle responsabilità connesse ad attacchi informatici, interruzioni di servizio e perdita di dati.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Lo Studio assiste imprese, investitori, fondi immobiliari, società immobiliari, enti previdenziali ed enti di edilizia residenziale pubblica nella gestione e valorizzazione di patrimoni immobiliari. L'attività comprende la strutturazione giuridica di operazioni immobiliari, la redazione e negoziazione di contratti di compravendita, locazione, leasing, appalto e sviluppo immobiliare, nonché l'assistenza nella due diligence legale su patrimoni e singoli immobili. Particolare rilievo assume l'assistenza nel contenzioso immobiliare, ove Legalit presta difesa in controversie complesse relative a contratti di locazione e godimento, appalti e responsabilità dell'appaltatore, vizi e difformità costruttive, responsabilità professionale di progettisti e direttori dei lavori, risoluzione di contratti preliminari, azioni di rilascio e sfratto, nonché contenzioso condominiale e azioni petitorie e possessorie. Lo Studio assiste fondi, società immobiliari, enti pubblici, aziende di edilizia residenziale pubblica ed enti previdenziali nella gestione di contenziosi seriali e strutturati su patrimoni immobiliari rilevanti. Lo Studio supporta infine i clienti nella gestione dei profili amministrativi, urbanistici e autorizzativi connessi agli interventi edilizi e alle operazioni di trasformazione e valorizzazione immobiliare. L'integrazione con le practice di diritto societario, tributario, amministrativo e banking & finance consente di affrontare in modo unitario le operazioni e i conflitti connessi agli asset immobiliari, valutandone gli impatti patrimoniali, finanziari e reputazionali.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Legalit assiste i Clienti nella tutela, organizzazione e protezione del patrimonio personale e familiare, con un approccio orientato alla prevenzione dei rischi e alla continuità generazionale. Lo Studio offre consulenza nella pianificazione successoria e nella gestione dei passaggi generazionali, supportando i clienti nella definizione di assetti patrimoniali idonei a garantire stabilità, equilibrio tra gli eredi e continuità dell'impresa familiare. Particolare attenzione è dedicata alla tutela del patrimonio nelle situazioni di crisi familiare, quali separazioni e divorzi, che possono incidere in modo significativo non solo sul patrimonio personale ma anche sugli equilibri economici e sull'assetto proprietario dell'impresa. L'assistenza è finalizzata a preservare il valore degli asset e a contenere l'impatto delle vicende personali sulla sfera imprenditoriale. L'attività comprende la redazione di testamenti, patti di famiglia e strumenti di regolazione dei rapporti patrimoniali tra coniugi, nonché la strutturazione di soluzioni volte alla protezione del patrimonio rispetto a potenziali esposizioni debitorie o situazioni di vulnerabilità personale. Legalit presta inoltre assistenza nelle controversie ereditarie e nei conflitti familiari con rilevanza patrimoniale, garantendo un approccio strategico volto alla tutela degli interessi economici e alla salvaguardia della riservatezza.",
  ...
  },
  {
    ...
    fullDescriptionIT: "Lo Studio assiste enti del Terzo Settore, associazioni, fondazioni, imprese sociali e organizzazioni no profit nella gestione dei profili giuridici, organizzativi e di governance connessi alla loro attività, offrendo un supporto strutturato e orientato alla vocazione etica di tali enti. Lo Studio fornisce consulenza nella costituzione e nell'adeguamento statutario degli enti, nella gestione dei rapporti con il RUNTS e nell'interpretazione della normativa di settore, assicurando la corretta qualificazione giuridica dell'ente e la conformità ai requisiti previsti dal Codice del Terzo Settore. Particolare attenzione è dedicata ai rapporti con la Pubblica Amministrazione, anche con riferimento alla partecipazione a bandi, convenzioni e procedure di affidamento, nonché alla gestione di finanziamenti e contributi pubblici. Lo Studio presta assistenza agli organi direttivi nella valutazione e gestione dei profili di responsabilità penale, civile e patrimoniale degli amministratori, con particolare riguardo alla corretta gestione dei fondi, al rispetto degli obblighi di legge e alla prevenzione di situazioni di conflitto o di mala gestio. Un ambito centrale dell'attività è rappresentato dallo sviluppo di progetti di compliance integrata, che includono la predisposizione e l'aggiornamento di modelli organizzativi ex D.Lgs. 231/01, la strutturazione dei sistemi di controllo interno, procedure whistleblowing, presidi in materia di anticorruzione e trasparenza, l'adeguamento al Codice del Terzo Settore, nonché i profili di sicurezza sul lavoro, gli adempimenti in materia di protezione dei dati personali e privacy, nonché l'integrazione di principi ESG nei processi organizzativi e decisionali dell'ente.",
