...
const translations: Translations = {
  ...
  "resetPassword.requirements": {
    it: "Minimo 12 caratteri, con almeno una maiuscola, una minuscola, un numero e un simbolo speciale.",
    en: "Minimum 12 characters, with at least one uppercase, one lowercase, one number and one special character."
  },
  ...
  // ValuesSection
  "values.quality": {
    it: "Qualità ed Efficienza",
    en: "Quality and Efficiency"
  },
  "values.qualityDesc": {
    it: "È nostra convinzione che un approccio contemporaneo alla professione forense imponga ai legali di assumere forme organizzative che riescano a rispondere con maggiore efficienza alle necessità dell'impresa, saperne parlare il linguaggio, essere in linea con i tempi brevi che le attività d'impresa impongono e, soprattutto, consentire al cliente di trovare nello studio legale un partner che sia in grado di assisterlo in ogni ambito territoriale in cui si trovi ad operare.",
    en: "We believe that a contemporary approach to the legal profession requires lawyers to adopt organizational structures that can respond more efficiently to business needs, speak its language, keep up with the fast pace that business activities demand and, above all, allow the client to find in the law firm a partner capable of assisting them in every territorial area in which they operate."
  },
  "values.transparency": {
    it: "Trasparenza",
    en: "Transparency"
  ...
  "values.transparencyDesc": {
    it: "Il cliente è sempre messo in condizione di seguire con massima trasparenza lo sviluppo della propria pratica e dell'eventuale procedimento giudiziario, venendo sempre coinvolto in prima persona nelle scelte nodali del procedimento. La comunicazione costante e chiara è alla base del nostro rapporto con ogni cliente.",
    en: "The client is always kept fully informed about the progress of their case and any legal proceedings, always being personally involved in key procedural decisions. Constant and clear communication is the foundation of our relationship with every client."
  },
  "values.experience": {
    it: "Esperienza",
    en: "Experience"
  ...
  "values.experienceDesc": {
    it: "Con oltre 30 anni di esperienza, il nostro team di professionisti ha gestito migliaia di casi con successo, costruendo una reputazione di eccellenza nel panorama legale italiano. La nostra competenza spazia in tutti i principali settori del diritto, garantendo assistenza qualificata e risultati concreti.",
    en: "With over 30 years of experience, our team of professionals has successfully handled thousands of cases, building a reputation for excellence in the Italian legal landscape. Our expertise spans all major areas of law, ensuring qualified assistance and concrete results."
  },
  "values.availability": {
    it: "Disponibilità",
    en: "Availability"
  ...
  "values.availabilityDesc": {
    it: "Siamo sempre disponibili per i nostri clienti. Comprendiamo che le questioni legali non seguono orari d'ufficio e ci impegniamo a fornire supporto tempestivo quando ne avete bisogno. La nostra presenza su tutto il territorio nazionale garantisce vicinanza e reperibilità costante.",
    en: "We are always available for our clients. We understand that legal matters don't follow office hours and we are committed to providing timely support when you need it. Our nationwide presence ensures proximity and constant availability."
  },
  "values.corporateKit": {
    it: "Kit Aziendale",
    en: "Corporate Kit"
  ...
  "values.corporateKitDesc": {
    it: "Per i clienti istituzionali ed i grandi clienti, che devono monitorare l'andamento di un elevato numero di posizioni, lo studio ha ideato e messo a loro disposizione un particolare archivio on line, dove sono custoditi, in massima sicurezza, i dati delle pratiche e che permette a ciascun cliente di poter accedere solo alle proprie posizioni attraverso identificativi e password personalizzate e modificate periodicamente.",
    en: "For institutional and large clients who need to monitor a high number of cases, the firm has designed and made available a special online archive where case data is stored with maximum security, allowing each client to access only their own cases through personalized and periodically updated IDs and passwords."
  }
};
