      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="text-white">e creare </span><span ref={accentWord3Ref} className="italic" style={{ color: '#003767', WebkitTextStroke: '5px white', paintOrder: 'stroke fill' }}>{Array.from("valore").map((ch, i) => <span key={i} className="accent-letter" style={{ display: 'inline-block', position: 'relative', zIndex: 1, opacity: 0 }}>{ch}</span>)}</span>
          </h1>
