...
const lawyerMap: Record<string, { name: string; id: string; area: string }> = {
  ...
  "stefanelli": { name: "Avv. Laura Stefanelli", id: "13", area: "Civile / Gestione del Credito" },
  "laura stefanelli": { name: "Avv. Laura Stefanelli", id: "13", area: "Civile / Gestione del Credito" },
  ...
  "adamo": { name: "Avv. Carmelina Adamo", id: "14", area: "Penale / Tutela Patrimoni" },
  "carmelina adamo": { name: "Avv. Carmelina Adamo", id: "14", area: "Penale / Tutela Patrimoni" },
  ...
  "ialongo": { name: "Avv. Giorgio Ialongo", id: "19", area: "Civile / Gestione del Credito" },
  "giorgio ialongo": { name: "Avv. Giorgio Ialongo", id: "19", area: "Civile / Gestione del Credito" },
