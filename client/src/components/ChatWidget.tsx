...
const lawyerMap: Record<string, { name: string; id: string; area: string }> = {
  ...
  "stefanelli": { name: "Avv. Laura Stefanelli", id: "13", area: "Civile / Gestione Crediti" },
  "laura stefanelli": { name: "Avv. Laura Stefanelli", id: "13", area: "Civile / Gestione Crediti" },
  ...
  "ialongo": { name: "Avv. Giorgio Ialongo", id: "19", area: "Civile / Gestione Crediti" },
  "giorgio ialongo": { name: "Avv. Giorgio Ialongo", id: "19", area: "Civile / Gestione Crediti" },
