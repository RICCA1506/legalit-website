  ...
  return (
    <section className="overflow-hidden">
      ...
      {valuesData.map((value) => (
        ...
        >
          <StaggerItem 
            className="flex-1 flex items-center py-8 md:py-10 lg:py-16 px-5 md:px-6 lg:px-16"
            y={30}
          >
            <div className="max-w-xl">
              <LandoReveal 
                ...
                delay={100}
              />
              <p className="text-muted-foreground leading-relaxed text-[15px] md:text-base lg:text-lg">
                {t(value.descKey)}
              </p>
            </div>
          </StaggerItem>
